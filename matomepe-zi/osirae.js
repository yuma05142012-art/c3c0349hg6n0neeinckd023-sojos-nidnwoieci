...
// お知らせカード
const EVENTS = [
  {day:4, title:'12月4日二学期最終授業', desc:'この日が二学期最後の授業です。   第8回目の漢字テストp54下', tags:['連絡・テスト']},
  {day:5, title:'期末テスト', desc:'12月5日は国語と英語がテスト', tags:['テスト']},
  {day:8, title:'期末テスト', desc:'12月8日は音楽と理科がテスト', tags:['テスト']},
  {day:9, title:'期末テスト', desc:'12月9日は英語と保険がテスト', tags:['テスト']},
  {day:10, title:'期末テスト', desc:'12月10日期末テスト4日目', tags:['テスト']},
  {day:19, title:'終業式', desc:'12月19日は学びのリフレクションと数学がテストです', tags:['終業式']},
];
...
const BULLETIN_ITEMS = [
  {title:'11月号', desc:'とても残念なことですが、盗難や現金の抜き取りなどが立て続けに起きてしまいました。ひとりひとりが安心して過ごせる学校とは程遠いことが起きてしまったこと、悲しくも、そして腹立たしくもあります。嫌な思いをした人がこのクラスにもいます。これまでの声かけや働きかけが足りない部分もあったのかと、被害を受けてしまう人が出る前に守りきれなかったことを反省もしています。ごめんなさい。今日の礼拝でも、そしてHRの時間にもお話をしたとおり、被害者はもちろん、加害者になってしまった人がいる現実も悲しいものです。いうまでもありませんが、人のものに手を出すことは、ものの種類や金額にかかわらず、犯罪です。 改めて、４月にみんなと約束した、ひとりひとりが安心して過ごせる学校に向かっていくために、みんなの気持ちと力を注いでほしいと強く、切実に願っています。 保護者のみなさまにも、たくさんのご心配をいただくこととなり、重ねて申し訳なく思っております。お子様を送り出してくださることに感謝をいたしますとともに、改めて、同じことの起きないよう、安心安全な学校生活を守れますよう、力を注いで参ります。よろしくお願い申し上げます。', tags:['山野先生からの言葉']},
];
