...
// お知らせカード
const EVENTS = [
  {day:9, title:'高校入試　購買・食堂休業', desc:'', tags:['臨時']},
  {day:10, title:'高校入試　購買・食堂休業', desc:'', tags:['臨時']},
  {day:12, title:'家庭学習日', desc:'家庭学習日', tags:['家庭学習日']},
...
const BULLETIN_ITEMS = [
  {title:'1月号', desc:'いつもお支えをありがとうございます。日々のお支えに、改めまして、ありがとうございます。この1月は、人試もあり、なかなか学校生活のリズムを整えにくいまま過ぎていきがちです。だからこそ、互いに毎日をたいせつにし、ひとりひとりが安心して過ごすための風土をととのえたいと考えます。これまでにできたことに目を向けながら、自分も他人も大切にできるような毎日を、全員でつくりたいと思います。寒の入りとなり、寒さが身に染むころでもあります。どうかご自愛ください。本年もよろしくお願い申し上げます。', tags:['山野先生からの言葉']},
];
