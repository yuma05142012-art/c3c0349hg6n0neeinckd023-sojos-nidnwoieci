...
// お知らせカード
const EVENTS = [
  {day:7, title:'月曜の時間割進行', desc:'11月7日金曜日は、月曜の時間割進行で進みます。', tags:['時間割変更']},
  {day:10, title:'人権学習', desc:'詳しいことはメニューの、プリントの写真を見てください。', tags:['時間割変更']},
  {day:13, title:'漢字テスト', desc:'第6回目の漢字テストp50下', tags:['テスト']},
  {day:20, title:'漢字テスト', desc:'第7回目の漢字テストp54上', tags:['テスト']},
  {day:27, title:'月曜の時間割進行', desc:'11月27日木曜日は、月曜の時間割進行で進むため、体育はありません。', tags:['時間割変更']},
  {day:28, title:'クラブ停止', desc:'期末テスト前なため、クラブが一時停止', tags:['クラブ']},
  {day:29, title:'同志社創立記念日', desc:'この日は土曜なため、特に何もありません。', tags:['記念日']},
