...
// お知らせカード
const EVENTS = [
  {day:2, title:'期末テスト', desc:'英語L単語・国語', tags:['期末テスト']},
  {day:3, title:'期末テスト', desc:'音楽・理科', tags:['期末テスト']},
  {day:4, title:'期末テスト', desc:'保健・英語RW', tags:['期末テスト']},
  {day:5, title:'期末テスト', desc:'数学・学びのリフレクション・自由研究視聴・教科書配り', tags:['期末テスト']},
